...
public class Game {
     ...
     * @param monstersCount - number of monsters on the board
     */
    private List<Monster> createMonsters (int monstersCount) {
        return Stream.generate(Monster::new).limit(monstersCount).collect(Collectors.toList());
    }
     ...
     * @param numBlocks - length of list.
     * @return - list of blocks.
     */
    private List<Block> createBlocks(int numBlocks){
        return Stream.generate(Block::new).limit(numBlocks).collect(Collectors.toList());
    }
